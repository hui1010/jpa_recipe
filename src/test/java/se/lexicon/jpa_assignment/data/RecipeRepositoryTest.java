...
//        testTwoIngredients.add(recipeIngredient3);
        ...
        testOne.addRecipeIngredient(recipeIngredient2);//testOne contains tomato and egg
...
//        System.out.println(testOne.getRecipeIngredients().contains(recipeIngredient1));//tomato
//        System.out.println(testOne.getRecipeIngredients().contains(recipeIngredient2));//egg
//        System.out.println(testTwo.getRecipeIngredients().contains(recipeIngredient2));//egg
//        System.out.println(testTwo.getRecipeIngredients().contains(recipeIngredient3));//mushroom
//
//        System.out.println(testTwo.getRecipeIngredients().size());
//        System.out.println(found1.contains(testOne));
//        System.out.println(found2.contains(testTwo));
